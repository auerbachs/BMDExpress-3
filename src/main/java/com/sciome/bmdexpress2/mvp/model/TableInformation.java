...
public class TableInformation
{
	...
	private Map<String, Boolean> curveFitMap;
	private LinkedList<String> curveFitOrder;
	...
	public TableInformation()
	{
		...
		this.curveFitMap = new HashMap<String, Boolean>();
	...
	public void setCurveFitMap(Map<String, Boolean> curveFitMap)
	{
		this.curveFitMap = curveFitMap;
	}

	public LinkedList<String> getCurveFitOrder()
	{
		return curveFitOrder;
	}

	public void setCurveFitOrder(LinkedList<String> curveFitOrder)
	{
		this.curveFitOrder = curveFitOrder;
	}
