...
public class TPODAnalysisDataVisualizationPresenter extends DataVisualizationPresenter
{

	public TPODAnalysisDataVisualizationPresenter(IDataVisualizationView view, IVisualizationService service,
	...
	public List<BMDExpressAnalysisDataSet> getResultsFromProject(List<BMDExpressAnalysisDataSet> exclude)
	{
		...
		if (bmdProject != null && bmdProject.getTpodAnalysisResults() != null)
		{
			for (TPODAnalysisResults catResults : bmdProject.getTpodAnalysisResults())
