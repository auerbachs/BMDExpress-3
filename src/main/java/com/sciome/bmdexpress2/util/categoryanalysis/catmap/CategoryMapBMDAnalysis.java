 ...
 */
public class CategoryMapBMDAnalysis extends CategoryMapBaseBMDAnalysis
{
	 ...
	 *
	 */
	public CategoryMapBMDAnalysis(int c0, int c1, int c2, Object[][] mData, ProbeGeneMapsBMDAnalysis probeGeneMaps)
	{
		super();
