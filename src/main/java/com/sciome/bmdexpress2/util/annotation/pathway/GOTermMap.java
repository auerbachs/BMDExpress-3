...
public class GOTermMap extends CategoryMapBase
{
	...
	private void geneIdsToGo(String goAll)
	{
		...
		subHash = new Hashtable<String, Vector<String>>(size / 2);
		allHash = new Hashtable<String, Vector<String>>(size * 3 / 4);
	...
	{
		allHash = new Hashtable<String, Vector<String>>(subHash.size() + subHash.size() / 4);
	 ...
	 */
	private void addToHash(Hashtable<String, Vector<String>> hash, String key, String value)
	{
