...
public abstract class CategoryMapBase
{
	...
	protected Hashtable<String, Vector<String>> subHash, allHash, dataSetGeneHash;
	...
	public Hashtable<String, String> getTitleHash()
	{
		return titleHash;
	}
	...
	public Hashtable<String, Vector<String>> subHash()
	{
		return subHash;
	}

	public Hashtable<String, Vector<String>> allHash()
	{
		return allHash;
	}

	public Hashtable<String, Vector<String>> dataSetGeneHash()
	{
