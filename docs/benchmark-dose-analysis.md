...
- **CurveFit Prefilter Goodness of Fit**: This value comes from the Curve Fit prefilter, only if it was run.
...
The curve that is shown initially is the one  with the best fit [as described in the introduction](index#basic-workflow), but you can view the fit of other models by using the *Model* dropdown menu.
